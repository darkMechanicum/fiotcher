...
class SimpleTrackerPool : TrackerPool, TrackerListenerRegistry {
     ...
     */
    private val registeredListeners = ConcurrentHashMap<String, CommonListener<TrackerEventBunch>>()
    ...
    override fun registerListener(listener: CommonListener<TrackerEventBunch>, key: String?) {
        checkIsStopping()
        val wrapped = key.wrapKey
